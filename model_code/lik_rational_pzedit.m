function [lik,latents] = lik_rational_pzedit(x,data)
    ...
    % separate intervention probabilities by condition.
    %
    ...
    for n = 1:data.N
        ...
        if r == 1 %if reward received = 1
            ...
            elseif data.cond(n)==3 %and condition = random
                pz = mean(data.latent_guess(data.cond == 3*(data.r == 0)));
